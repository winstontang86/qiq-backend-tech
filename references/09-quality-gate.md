...
| Q-4 | NFR 摘要表 | 至少覆盖 SLA / QPS / 延迟 / 一致性 / 容量 / 安全（含越权 + 漏洞）6 维度，每条含具体数字 | Blocker |
...
| Q-15 | 故障矩阵 | 覆盖单机 / 机房 / 网络 / 时钟 / 依赖 / 流量 / 数据 / **安全（越权）** / **安全（漏洞）** / 发布 10 类 | High |
...
2. **NFR 缺失关键维度**：可用性 / QPS / 延迟 / 数据一致性 / 安全 中任一未给具体数。
